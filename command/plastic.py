...
_COOLDOWN_MESSAGES = (
    "앗, 방금 던져써!! 손이 아직 안 풀렸어!! _(당황)_",
    "페트병아 쪼금만 기다려줘!! 햄미 손이 아직 쉬는 중이야!! _(초조)_",
    "어어, 버튼 눌렀는데 업써!! 손이 꼼짝을 안 해!! _(황당)_",
    "한 번 던졌더니 힘이 쏙 빠져써!! 다시 던지려면 기다려야 해!! _(기운)_",
    "페트병이 어디 갔는지 안 보여!! 햄미 억울해!! _(억울)_",
    "페트병이 아직 하늘에서 못 내려왔나 봐!! _(멍함)_",
    "또 던지고 싶은데 손가락이 안 움직여!! 잠깐만 기다리자!! _(답답)_",
    "앗차차, 팔에 힘이 하나도 없어!! 너무 빨리 던지려 그랬나 봐!! _(실수)_",
    "손이 아직도 후들후들해!! 조금만 더 기다려줘!! _(기다림)_",
    "던지기 버튼이 잠들어써!! 깨워도 꿈쩍도 안 해!! _(졸림)_",
    "방금 던진 힘을 충전하는 중이야!! 금방 다시 흔들 수 이써!! _(충전)_",
    "페트병 또 던지고 싶은데 너무 힘들어서 못 찾겠어!! _(삐짐)_",
    "페트병이 어디 있는지 전혀 안 보여!! 좀 더 찾아봐야 해!! _(체념)_",
    "이제 좀 던질 수 있으려나 했는데 아직이었어!! _(실망)_",
    "한 번 힘껏 던졌더니 완전히 지쳐써!! 잠깐 쉴게!! _(휴식)_",
    "왜 또 안 던져지지?? 아직 힘이 안 돌아왔나 봐!! _(깨달음)_",
    "페트병을 다시 잡았는데 손에 힘이 안 들어가!! _(끙)_",
    "손은 멀쩡한데 페트병이 안 보여!! _(애원)_",
    "조아, 기다릴게!! 힘 차면 바로 힘껏 던질 거야!! _(의지)_",
...
_COOLDOWN_WARNING_MESSAGES = (
    ...
    "아직 못 던진다니까!! 다음엔 진짜 화낼 거야!! _(경고)_",
