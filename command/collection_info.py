...
# 안내한다. documents/collection_guide.py(자연어 RAG 문서)도 이 상수를 그대로
# 재사용한다(2026-09-10) — 밑줄 없는 공개 이름인 이유.
COLLECTION_NOTICE = (
    "햄미가 저장하는 정보는 이래!!\n"
    "- 채팅 횟수 · 도와준 횟수 · 호감도\n"
    "- 동전 · 간식 · 업적 등 게임 관련 기록\n"
...
async def handle(interaction: discord.Interaction) -> None:
    ...
    await interaction.edit_original_response(content=COLLECTION_NOTICE)
